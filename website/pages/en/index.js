        ...
        return (
            <SplashContainer>
                ...
                <div className="inner">
                    ...
                    <PromoSection>
                        <Button href="https://github.com/cavineers" target="_blank">
                            GitHub
                        </Button>
                        <Button href="https://cavineers.github.io" target="_blank">
                            Website
                        </Button>
                        <Button href={docUrl("home")}>Docs</Button>
                    </PromoSection>
                </div>
            </SplashContainer>
        );
    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="mainContainer">{/* <Features />
                    <FeatureCallout />
                    <LearnHow />
                    <TryOut />
                    <Description />
